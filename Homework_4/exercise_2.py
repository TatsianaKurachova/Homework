...
book_of_phone_number_list = [
    ['Tatsiana', '+37525 222 22 22'], 
    ['Artem', '+37529 888 88 88'], 
    ['Alex', '+375 44 555 55 55'], 
    ['Galina', '+375 29 999 99 99'], 
    ['Kirill', '+375 29 777 77 77'],
]
book_numbers = dict(book_of_phone_number_list)

# Меняем местами первый и последний элементы

# Удаляем второй элемент
del book_numbers ['Alex']

# Вставляем новый элемент
book_numbers['Anton'] = '+375 44 222 22 22'
print(book_numbers)
